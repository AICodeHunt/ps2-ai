    ...
    return (
        <main
            ...
            <div
                ...
                <p>
                    Welcome to PS2 AI, accessible from ps2ai.com. Please read these Terms
                    of Service ("Terms", "Terms of Service") carefully before using the PS2 AI web
                    application ("Service").
                </p>
                ...
                <p>
                    <ul className="list-inside list-disc">
                        ...
                        <li>
                            PS2 AI has the right, but not the obligation, to monitor and review any
                ...
                <p>
                    All content, features, and functionality of the Service are owned by PS2 AI, its
                ...
                <p>
                    The Service is provided on an "as is" and "as available" basis. PS2 AI makes no
                ...
                <p>
                    In no event shall PS2 AI, nor its directors, employees, partners, or agents, be
